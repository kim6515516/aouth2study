...
var getAccessToken = function(req, res, next) {
    ...
    // filter.where('removed', false);
	   ...
	   //      if (response.access_token == inToken) {
				// return response;
			// }
